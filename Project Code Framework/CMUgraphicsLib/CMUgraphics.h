...
class window {
  ...
  public:
	...
	//More Efficient waiting procedure by Karim
	void WaitUserInput();
	...
	//Display an interactive message box (Added by Karim)
	int Display_MessageBox(string Msg,string title,UINT Type);
